...
import com.subscriptionmanager.usage.controller.UsageSignalController;
...
class UsageSignalsContractTest {
    ...
    @Test
    void usageSignalsCreateContract() throws Exception {
        String body = """
                {
                  "subscriptionId": 123,
    ...
    @Test
    void usageSignalsListContract() throws Exception {
        when(currentUserService.requireCurrentUserId()).thenReturn(1L);
        when(usageSignalService.list(1L, 123L))
                .thenReturn(List.of(
                        new UsageSignalResponse(
                                2L,
                                123L,
                                "APP_OPENED",
                                "session=morning",
        ...
        mockMvc.perform(get("/api/v1/usage-signals").queryParam("subscriptionId", "123"))
                ...
                .andExpect(jsonPath("$[1].signalType").value("CONTENT_WATCHED"));
    }

    @Test
    void usageSignalsValidationErrorShapeContract() throws Exception {
        String body = """
                {
                  "subscriptionId": 0,
                  "signalType": "",
    ...
    @Test
    void usageSignalsBusinessErrorShapeContract() throws Exception {
        String body = """
                {
                  "subscriptionId": 999,
                  "signalType": "CONTENT_WATCHED",
